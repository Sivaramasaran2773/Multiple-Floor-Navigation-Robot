...
#Using the Navigator Function to pose the robot
...
def main():
    ...
    #Deleting model for next stage
    from subprocess import call
    call(["ros2", "launch", "multi_nav", "gz_respawner_stage2.py"])
    ...
    #Closing down the ROS 2 Navigation Stack
